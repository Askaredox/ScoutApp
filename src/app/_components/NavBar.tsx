...
const NavBar: React.FC<NavBarProps> = ({
  ...
  function get_avatar(user: User) {
    if (user.avatar === null || user.avatar === "NONE") {
      return (
        ...
        user.sub.replace(/\D/g, "").slice(0, 8)
      );
    } else {
      return user.avatar;
    }
  ...
  return (
    <div>
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                ...
                <div
                  ...
                  role="tooltip"
                  className={
                    "top-14 right-1 z-30 w-64 text-sm text-gray-500 transition-opacity absolute duration-300 bg-white border border-gray-200 rounded-lg shadow-xs dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600" +
                    (userMenuOpen ? " inline-block" : " hidden")
                  }
                >
                  <div>
      ...
      <aside
        id="logo-sidebar"
        className={`fixed top-0 left-0 z-40 w-56 h-screen pt-16 transition-transform ${sidenav ? "translate-x-0" : "-translate-x-full"} bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700`}
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="font-medium">
            ...
            <li>
              <a
                href={
                  "/biblioteca" + (user?.groups === "Admin" ? "-editor" : "")
                }
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
            ...
            <li>
              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSdoF-wmhPf4EhrVk3qHe8o8NSLuuYYoyhU_nItCbcd1_tnroA/viewform?usp=sharing&ouid=110963328688090878258"
                target="_blank"
                className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg

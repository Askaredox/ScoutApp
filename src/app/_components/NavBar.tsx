...
const NavBar: React.FC<NavBarProps> = ({ callback = () => console.log('ok') }) => {
    ...
    return (
        <div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <div className="flex items-center ms-3">
                                <button data-popover-target="popover-user-profile" data-popover-placement="left" type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 cursor-pointer" onClick={open_user} aria-haspopup="true" >
                                ...
                                <div data-popover id="popover-user-profile" role="tooltip" className={"top-14 right-1 z-10 inline-block w-64 text-sm text-gray-500 transition-opacity absolute duration-300 bg-white border border-gray-200 rounded-lg shadow-xs dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600" + (userMenuOpen ? " opacity-100" : " invisible opacity-0")}>
                                    <div >
            ...
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-56 h-screen pt-20 transition-transform ${sidenav ? "translate-x-0" : "-translate-x-full"} bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`} aria-label="Sidebar">
